...
$query = $con->prepare("SELECT password,id FROM examsection WHERE username='$username'");
$query->execute();
...
if(password_verify($password,$password_hash)) {
  session_start();
  $_SESSION['examsection'] = $username;
  $_SESSION['examsection_id'] = $id;
  redirect('examsection_home.php');
}
else {
